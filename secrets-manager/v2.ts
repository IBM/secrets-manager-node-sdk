...
/**
 * With IBM Cloud® Secrets Manager Basic plan , you can create, lease, and centrally manage secrets that are used in IBM
 * Cloud services or your custom-built applications. Secrets are managed in a multi-tenant instance of Secrets Manager.
 *
 * API Version: 2.0.0
...
class SecretsManagerV2 extends BaseService {
   ...
   * items that starts with the `offset` value. Use `offset` with `limit` to look through your available resources.
   *
   ...
   * of these fields: `id`, `name`, `description`,
   * `labels`, `secret_type`.
   *
  ...
  public createSecretVersion(
    ...
    const _params = { ...params };
    const _requiredParams = ['id', 'secretVersionPrototype'];
    const _validParams = ['id', 'secretVersionPrototype', 'headers'];
    const _validationErrors = validateParams(_params, _requiredParams, _validParams);
    if (_validationErrors) {
      return Promise.reject(_validationErrors);
    }
   ...
   * @param {Object} params - The parameters to send to the service.
   * @param {string} params.id - The v4 UUID that uniquely identifies your secret.
   * @param {string} params.versionId - The v4 UUID that uniquely identifies your secret version. You can use the
   * `current` or `previous` aliases to refer to the current or previous secret version.
   * @param {OutgoingHttpHeaders} [params.headers] - Custom request headers
   * @returns {Promise<SecretsManagerV2.Response<SecretsManagerV2.SecretVersion>>}
   */
  public getSecretVersion(
    ...
    const _params = { ...params };
    const _requiredParams = ['id', 'versionId'];
    const _validParams = ['id', 'versionId', 'headers'];
    const _validationErrors = validateParams(_params, _requiredParams, _validParams);
    if (_validationErrors) {
      return Promise.reject(_validationErrors);
    }
    ...
    const parameters = {
      options: {
        url: '/v2/secrets/{id}/versions/{version_id}',
        method: 'GET',
        path,
      },
      defaultOptions: extend(true, {}, this.baseOptions, {
  ...
  public deleteSecretVersionData(
    ...
    const parameters = {
      options: {
        url: '/v2/secrets/{id}/versions/{version_id}/secret_data',
        method: 'DELETE',
        path,
      },
      defaultOptions: extend(true, {}, this.baseOptions, {
  ...
  public getSecretVersionMetadata(
    ...
    const parameters = {
      options: {
        url: '/v2/secrets/{id}/versions/{version_id}/metadata',
        method: 'GET',
        path,
      },
      defaultOptions: extend(true, {}, this.baseOptions, {
  ...
  public updateSecretVersionMetadata(
    ...
    const _params = { ...params };
    const _requiredParams = ['id', 'versionId'];
    const _validParams = ['id', 'versionId', 'versionCustomMetadata', 'headers'];
    const _validationErrors = validateParams(_params, _requiredParams, _validParams);
    if (_validationErrors) {
      return Promise.reject(_validationErrors);
    }
  ...
  public createSecretVersionAction(
    ...
    const _params = { ...params };
    const _requiredParams = ['id', 'versionId', 'secretVersionActionPrototype'];
    const _validParams = ['id', 'versionId', 'secretVersionActionPrototype', 'headers'];
    const _validationErrors = validateParams(_params, _requiredParams, _validParams);
    if (_validationErrors) {
      return Promise.reject(_validationErrors);
    }
    ...
    const parameters = {
      options: {
        url: '/v2/secrets/{id}/versions/{version_id}/actions',
        method: 'POST',
        body,
        path,
      },
   ...
   */
  public createSecretLocks(
    params: SecretsManagerV2.CreateSecretLocksParams
   ...
   * `..?offset=25&limit=25`.
   * @param {number} [params.limit] - The number of locks that are associated with the secret that you want to retrieve.
   * By default, list operations return the first 25 items. To retrieve a different set of items, use `limit` with
   * `offset` to look through your available resources.
   *
   ...
   * @returns {Promise<SecretsManagerV2.Response<SecretsManagerV2.SecretLocks>>}
   */
  public deleteSecretLocks(
    params: SecretsManagerV2.DeleteSecretLocksParams
  ): Promise<SecretsManagerV2.Response<SecretsManagerV2.SecretLocks>> {
    const _params = { ...params };
    const _requiredParams = ['id'];
   ...
   * @returns {Promise<SecretsManagerV2.Response<SecretsManagerV2.SecretLocks>>}
   */
  public createSecretVersionLocks(
    params: SecretsManagerV2.CreateSecretVersionLocksParams
  ): Promise<SecretsManagerV2.Response<SecretsManagerV2.SecretLocks>> {
    const _params = { ...params };
    const _requiredParams = ['id', 'versionId', 'locks'];
    const _validParams = ['id', 'versionId', 'locks', 'mode', 'headers'];
    const _validationErrors = validateParams(_params, _requiredParams, _validParams);
    if (_validationErrors) {
      return Promise.reject(_validationErrors);
    }
    ...
    const sdkHeaders = getSdkHeaders(
      SecretsManagerV2.DEFAULT_SERVICE_NAME,
      'v2',
      'createSecretVersionLocks'
    );

    const parameters = {
      options: {
        url: '/v2/secrets/{id}/versions/{version_id}/locks',
        method: 'POST',
        body,
        qs: query,
        path,
  ...
  public listSecretVersionLocks(
    ...
    const _params = { ...params };
    const _requiredParams = ['id', 'versionId'];
    const _validParams = ['id', 'versionId', 'offset', 'limit', 'sort', 'search', 'headers'];
    const _validationErrors = validateParams(_params, _requiredParams, _validParams);
    if (_validationErrors) {
      return Promise.reject(_validationErrors);
    }
   ...
   * @returns {Promise<SecretsManagerV2.Response<SecretsManagerV2.SecretLocks>>}
   */
  public deleteSecretVersionLocks(
    params: SecretsManagerV2.DeleteSecretVersionLocksParams
  ): Promise<SecretsManagerV2.Response<SecretsManagerV2.SecretLocks>> {
    const _params = { ...params };
    const _requiredParams = ['id', 'versionId'];
    const _validParams = ['id', 'versionId', 'name', 'headers'];
    const _validationErrors = validateParams(_params, _requiredParams, _validParams);
    if (_validationErrors) {
      return Promise.reject(_validationErrors);
    }
   ...
   *
   *
   * **Available values:**  created_at | updated_at | config_type | secret_type | name
   *
   * **Usage:** To sort a list of configurations by their creation date, use
   * `../configurations?sort=created_at`.
  ...
  public createConfigurationAction(
    ...
    const _validParams = ['name', 'configActionPrototype', 'headers'];
    const _validationErrors = validateParams(_params, _requiredParams, _validParams);
    if (_validationErrors) {
      return Promise.reject(_validationErrors);
    }
...
namespace SecretsManagerV2 {
  ...
  export interface ListSecretsParams {
     ...
     *  `offset` value. Use `offset` with `limit` to look through your available resources.
     *
     *  **Usage:** If you have 100 secrets in your instance, and you want to retrieve secrets 26 through 50, use
     *  `..?offset=25&limit=25`.
     */
     ...
     */
    sort?: string;
    /** Obtain a collection of secrets that contain the specified string in one or more of these fields: `id`,
     *  `name`, `description`,
     *  `labels`, `secret_type`.
     *
     *  **Usage:** If you want to list only the secrets that contain the string `text`, use
  ...
  /** Parameters for the `createSecretLocks` operation. */
  export interface CreateSecretLocksParams {
    /** The v4 UUID that uniquely identifies your secret. */
    id: string;
     ...
     */
    mode?: CreateSecretLocksConstants.Mode | string;
    headers?: OutgoingHttpHeaders;
  }

  /** Constants for the `createSecretLocks` operation. */
  export namespace CreateSecretLocksConstants {
  ...
  export interface ListSecretLocksParams {
     ...
     */
    offset?: number;
    /** The number of locks that are associated with the secret that you want to retrieve. By default, list
     *  operations return the first 25 items. To retrieve a different set of items, use `limit` with `offset` to look
  ...
  /** Parameters for the `deleteSecretLocks` operation. */
  export interface DeleteSecretLocksParams {
    /** The v4 UUID that uniquely identifies your secret. */
    id: string;
  ...
  /** Parameters for the `createSecretVersionLocks` operation. */
  export interface CreateSecretVersionLocksParams {
    /** The v4 UUID that uniquely identifies your secret. */
    id: string;
    /** The v4 UUID that uniquely identifies your secret version. You can use the `current` or `previous` aliases to
     *  refer to the current or previous secret version.
     ...
     *  the previous secret version if it doesn't have any locks.
     */
    mode?: CreateSecretVersionLocksConstants.Mode | string;
    headers?: OutgoingHttpHeaders;
  }

  /** Constants for the `createSecretVersionLocks` operation. */
  export namespace CreateSecretVersionLocksConstants {
    /** An optional lock mode. When you create a lock, you can set one of the following modes to clear any matching locks on a secret version. - `exclusive`: Removes any other locks with matching names if they are found in the previous version of the secret. - `exclusive_delete`: Completes the same action as `exclusive`, but also permanently deletes the data of the previous secret version if it doesn't have any locks. */
    export enum Mode {
      EXCLUSIVE = 'exclusive',
      EXCLUSIVE_DELETE = 'exclusive_delete',
  ...
  /** Parameters for the `deleteSecretVersionLocks` operation. */
  export interface DeleteSecretVersionLocksParams {
    /** The v4 UUID that uniquely identifies your secret. */
    id: string;
    /** The v4 UUID that uniquely identifies your secret version. You can use the `current` or `previous` aliases to
     *  refer to the current or previous secret version.
  ...
  export interface CertificateIssuanceInfo {
    ...
    ca?: string;
    /** The set of challenges. It is returned only when ordering public certificates by using a manual DNS
     *  configuration.
     */
    challenges?: ChallengeResource[];
    /** The name that is assigned to the DNS provider configuration. */
    dns?: string;
    /** The date that a user requests to "validate DNS challenges" for certificates that are ordered with a "manual"
     *  DNS provider. The date format follows RFC 3339.
     */
    ...
    /** The date the certificate is ordered. The date format follows RFC 3339. */
    ordered_on?: string;
  ...
  /** Specify the properties for your configuration action. */
  ...
  /** Specify the details for your configuration. */
  export interface ConfigurationPrototype {
  }

  /** The Event Notifications registration details. */
  ...
  export interface PaginatedCollectionFirst {
    /** A URL pointer to a page in a collection. */
    href: string;
  }
  ...
  /** The config data of your private certificate. */
  ...
  /** The response body of a request to create locks that contains a collection of locks that are attached to a secret. */
  ...
  /** Specify the properties for your version action. */
  ...
  /** Specify the properties for your secret version action. */
  ...
  /** Your arbitrary secret payload. */
  export interface ArbitrarySecretPayload extends SecretData {
  ...
  /** Properties that describe a ClassicInfrastructure DNS configuration. */
  ...
  /** IAM Credentials engine configuration update. */
  ...
  /** The payload of an IAM credentials secret. */
  export interface IAMCredentialsSecretPayload extends SecretData {
    /** The API key that is generated for this secret.
     *
     *  After the secret reaches the end of its lease (see the `ttl` field), the API key is deleted automatically. If
     *  you want to continue to use the same API key for future read operations, see the `reuse_api_key` field.
  ...
  export interface ImportedCertificate extends Secret {
    ...
    /** The Subject Alternative Name field can be used to specify additional host names to be protected by a single
     *  SSL certificate.
     */
    alt_names?: string[];
  ...
  /** The payload of an imported certificate. */
  export interface ImportedCertificatePayload extends SecretData {
  ...
  /** Properties of the metadata of your KV secret metadata. */
  ...
  /** The payload of a key-value secret. */
  export interface KVSecretPayload extends SecretData {
  ...
  export interface PrivateCertificate extends Secret {
     ...
     */
    alt_names?: string[];
    /** The intermediate certificate authority that signs the certificate. */
  ...
  /** Private certificate action Revoke response body. */
  ...
  /** Specify the properties for the Private certificate action Revoke. */
  ...
  /** Private certificate configuration action Revoke response body. */
  ...
  /** Specify the properties for the Private certificate configuration action Revoke. */
  ...
  /** The response body of the action to sign a CSR for the private certificate configuration. */
  export interface PrivateCertificateConfigurationActionSignCSR extends ConfigurationAction {
     ...
     */
    alt_names?: string[];
    /** The IP Subject Alternative Names to define for the CA certificate, in a comma-separated list. */
    ip_sans?: string;
    /** The URI Subject Alternative Names to define for the CA certificate, in a comma-separated list. */
    uri_sans?: string;
     ...
     *  signing certificate. A limit of `0` means a path length of zero.
     */
    max_path_length?: number;
    /** Controls whether the common name is excluded from Subject Alternative Names (SANs).
     *
     *  If set to `true`, the common name is not included in DNS or Email SANs if they apply. This field can be useful
     *  if the common name is a human-readable identifier, not a hostname or an email address.
     */
     ...
     *  `private_cert_configuration_action_sign_csr` action. If set to `true`, then:
     *
  ...
  /** Intermediate certificate authority configuration metadata properties. */
  ...
  export interface PrivateCertificateConfigurationRootCA extends Configuration {
     ...
     */
    other_sans?: string[];
    /** The requested time-to-live (TTL) for certificates that are created by this CA. This field cannot be longer
  ...
  /** The metadata properties of the root certificate authority configuration. */
  ...
  /** Root certificate authority configuration metadata patch. */
  ...
  /** The root certificate authority configuration. */
  ...
  export interface PrivateCertificateConfigurationTemplate extends Configuration {
    ...
    /** The maximum time-to-live (TTL) for certificates that are created by this CA in seconds. */
    max_ttl_seconds?: number;
    /** Specifies the requested time-to-live (TTL). After the TTL elapses, the certificate expires. */
    ttl_seconds?: number;
  ...
  /** The configuration of metadata properties of the private certificate template . */
  ...
  export interface PrivateCertificateConfigurationTemplatePrototype extends ConfigurationPrototype {
     ...
     *
     *  When set to false, this prevents wildcards from being issued even if they would've been allowed by an option
     *  `allow_glob_domains`.
     */
  ...
  /** The payload of your private certificate. */
  export interface PrivateCertificatePayload extends SecretData {
    /** Your PEM-encoded certificate. The data must be formatted on a single line with embedded newline characters. */
    certificate: string;
    /** The PEM-encoded private key that is associated with the certificate. The data must be formatted on a single
     *  line with embedded newline characters.
  ...
  /** Private certificate version action Revoke response body. */
  ...
  /** Public certificate action ValidateManualDNS response body. */
  export interface PublicCertificateActionValidateManualDNS extends SecretAction {
    /** The type of secret action. */
    action_type: string;
  }

  /** Specify the properties of the action `ValidateManualDNS` for your public certificate. */
  ...
  export interface PublicCertificateConfigurationCALetsEncrypt extends Configuration {
    ...
    /** The date that a resource was recently modified. The date format follows RFC 3339. */
    updated_at?: string;
    /** The configuration of Let's Encrypt CA's environment. */
  ...
  /** Your Lets Encrypt CA metadata properties. */
  ...
  /** Lets Encrypt Certificate Authority configuration update. */
  ...
  /** Specify the properties for Let's Encrypt CA configuration. */
  ...
  /** Your ClassicInfrastructure DNS metadata properties. */
  ...
  /** Properties that describe an IBM Cloud classic infrastructure (SoftLayer) configuration update. */
  ...
  /** Properties that describe a CloudInternetServices DNS configuration. */
  ...
  /** Your CloudInternetServices DNS metadata properties. */
  ...
  /** Cloud Internet Services DNS configuration update. */
  ...
  /** Specify the properties for CloudInternetServices DNS configuration. */
  ...
  /** The payload of a public certificate. */
  export interface PublicCertificatePayload extends SecretData {
    /** Your PEM-encoded certificate. The data must be formatted on a single line with embedded newline characters. */
    certificate: string;
    /** The PEM-encoded intermediate certificate that is associated with the root certificate. The data must be
     *  formatted on a single line with embedded newline characters.
  ...
  /** The payload of a user credentials secret. */
  export interface UsernamePasswordSecretPayload extends SecretData {
