...
const secretsManagerServiceOptions = {
  ...
  url: 'https://secrets-manager.cloud.ibm.com/api',
};
...
describe('SecretsManagerV2', () => {
  ...
  describe('createSecretGroup', () => {
    describe('positive tests', () => {
      function __createSecretGroupTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secret_groups', 'POST');
  ...
  describe('listSecretGroups', () => {
    describe('positive tests', () => {
      function __listSecretGroupsTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secret_groups', 'GET');
        const expectedAccept = 'application/json';
  ...
  describe('getSecretGroup', () => {
    describe('positive tests', () => {
      function __getSecretGroupTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secret_groups/{id}', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
  ...
  describe('updateSecretGroup', () => {
    describe('positive tests', () => {
      function __updateSecretGroupTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secret_groups/{id}', 'PATCH');
        const expectedAccept = 'application/json';
  ...
  describe('deleteSecretGroup', () => {
    describe('positive tests', () => {
      function __deleteSecretGroupTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secret_groups/{id}', 'DELETE');
  ...
  describe('createSecret', () => {
    describe('positive tests', () => {
      ...
      function __createSecretTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets', 'POST');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
  ...
  describe('listSecrets', () => {
    describe('positive tests', () => {
      function __listSecretsTest() {
        ...
        const groups = ['67d025e1-0248-418f-83ba-deb0ebfb9b4a', 'cac40995-c37a-4dcb-9506-472869077634'];
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
  ...
  describe('getSecret', () => {
    describe('positive tests', () => {
      function __getSecretTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(mockRequestOptions.path.id).toEqual(id);
  ...
  describe('deleteSecret', () => {
    describe('positive tests', () => {
      function __deleteSecretTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}', 'DELETE');
        const expectedAccept = undefined;
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(mockRequestOptions.path.id).toEqual(id);
  ...
  describe('getSecretMetadata', () => {
    describe('positive tests', () => {
      function __getSecretMetadataTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}/metadata', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(mockRequestOptions.path.id).toEqual(id);
  ...
  describe('updateSecretMetadata', () => {
    describe('positive tests', () => {
      ...
      function __updateSecretMetadataTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}/metadata', 'PATCH');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/merge-patch+json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
  ...
  describe('createSecretAction', () => {
    describe('positive tests', () => {
      ...
      function __createSecretActionTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}/actions', 'POST');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
  ...
  describe('createSecretVersion', () => {
    describe('positive tests', () => {
      ...
      function __createSecretVersionTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}/versions', 'POST');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
  ...
  describe('listSecretVersions', () => {
    describe('positive tests', () => {
      function __listSecretVersionsTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}/versions', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(mockRequestOptions.path.id).toEqual(id);
  ...
  describe('getSecretVersion', () => {
    describe('positive tests', () => {
      function __getSecretVersionTest() {
        ...
        const id = '0b5571f7-21e6-42b7-91c5-3f5ac9793a46';
        const versionId = 'eb4cf24d-9cae-424b-945e-159788a5f535';
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}/versions/{version_id}', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(mockRequestOptions.path.id).toEqual(id);
  ...
  describe('deleteSecretVersionData', () => {
    describe('positive tests', () => {
      function __deleteSecretVersionDataTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}/versions/{version_id}/secret_data', 'DELETE');
        const expectedAccept = undefined;
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(mockRequestOptions.path.id).toEqual(id);
  ...
  describe('getSecretVersionMetadata', () => {
    describe('positive tests', () => {
      function __getSecretVersionMetadataTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}/versions/{version_id}/metadata', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(mockRequestOptions.path.id).toEqual(id);
  ...
  describe('updateSecretVersionMetadata', () => {
    describe('positive tests', () => {
      function __updateSecretVersionMetadataTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}/versions/{version_id}/metadata', 'PATCH');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/merge-patch+json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
  ...
  describe('createSecretVersionAction', () => {
    describe('positive tests', () => {
      ...
      function __createSecretVersionActionTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}/versions/{version_id}/actions', 'POST');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
  ...
  describe('listSecretsLocks', () => {
    describe('positive tests', () => {
      function __listSecretsLocksTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets_locks', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(mockRequestOptions.qs.offset).toEqual(offset);
    ...
    describe('SecretsLocksPager tests', () => {
      const serviceUrl = secretsManagerServiceOptions.url;
      const path = '/v2/secrets_locks';
      const mockPagerResponse1 =
        '{"next":{"href":"https://myhost.com/somePath?offset=1"},"secrets_locks":[{"secret_id":"b49ad24d-81d4-5ebc-b9b9-b0937d1c84d5","secret_group_id":"default","secret_type":"arbitrary","secret_name":"my-secret","versions":[{"version_id":"b49ad24d-81d4-5ebc-b9b9-b0937d1c84d5","version_alias":"current","locks":["locks"],"payload_available":false}]}],"total_count":2,"limit":1}';
      const mockPagerResponse2 =
        '{"secrets_locks":[{"secret_id":"b49ad24d-81d4-5ebc-b9b9-b0937d1c84d5","secret_group_id":"default","secret_type":"arbitrary","secret_name":"my-secret","versions":[{"version_id":"b49ad24d-81d4-5ebc-b9b9-b0937d1c84d5","version_alias":"current","locks":["locks"],"payload_available":false}]}],"total_count":2,"limit":1}';
  ...
  describe('createSecretLocks', () => {
    describe('positive tests', () => {
      ...
      function __createSecretLocksTest() {
        // Construct the params object for operation createSecretLocks
        const id = '0b5571f7-21e6-42b7-91c5-3f5ac9793a46';
        const locks = [secretLockPrototypeModel];
        const mode = 'exclusive';
        const createSecretLocksParams = {
          id,
          locks,
          mode,
        };

        const createSecretLocksResult = secretsManagerService.createSecretLocks(createSecretLocksParams);

        // all methods should return a Promise
        expectToBePromise(createSecretLocksResult);
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}/locks', 'POST');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
      ...
      test('should prioritize user-given headers', () => {
        ...
        secretsManagerService.createSecretLocks(createSecretLocksParams);
        checkMediaHeaders(createRequestMock, userAccept, userContentType);
      });
    });
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await secretsManagerService.createSecretLocks({});
        } catch (e) {
          err = e;
        }
  ...
  describe('listSecretLocks', () => {
    describe('positive tests', () => {
      function __listSecretLocksTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}/locks', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(mockRequestOptions.qs.offset).toEqual(offset);
  ...
  describe('deleteSecretLocks', () => {
    describe('positive tests', () => {
      function __deleteSecretLocksTest() {
        // Construct the params object for operation deleteSecretLocks
        const id = '0b5571f7-21e6-42b7-91c5-3f5ac9793a46';
        const name = ['lock-1'];
        const deleteSecretLocksParams = {
          id,
          name,
        };

        const deleteSecretLocksResult = secretsManagerService.deleteSecretLocks(deleteSecretLocksParams);

        // all methods should return a Promise
        expectToBePromise(deleteSecretLocksResult);
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}/locks', 'DELETE');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
      ...
      test('should prioritize user-given headers', () => {
        ...
        secretsManagerService.deleteSecretLocks(deleteSecretLocksParams);
        checkMediaHeaders(createRequestMock, userAccept, userContentType);
      });
    });
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await secretsManagerService.deleteSecretLocks({});
        } catch (e) {
          err = e;
        }
  ...
  describe('createSecretVersionLocks', () => {
    describe('positive tests', () => {
      // Request models needed by this operation.
      ...
      function __createSecretVersionLocksTest() {
        // Construct the params object for operation createSecretVersionLocks
        const id = '0b5571f7-21e6-42b7-91c5-3f5ac9793a46';
        const versionId = 'eb4cf24d-9cae-424b-945e-159788a5f535';
        const locks = [secretLockPrototypeModel];
        const mode = 'exclusive';
        const createSecretVersionLocksParams = {
          id,
          versionId,
          locks,
          mode,
        ...
        const createSecretVersionLocksResult = secretsManagerService.createSecretVersionLocks(createSecretVersionLocksParams);

        // all methods should return a Promise
        expectToBePromise(createSecretVersionLocksResult);
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}/versions/{version_id}/locks', 'POST');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(mockRequestOptions.body.locks).toEqual(locks);
      ...
      test('should pass the right params to createRequest with enable and disable retries', () => {
        // baseline test
        __createSecretVersionLocksTest();
      ...
      test('should prioritize user-given headers', () => {
        ...
        secretsManagerService.createSecretVersionLocks(createSecretVersionLocksParams);
        checkMediaHeaders(createRequestMock, userAccept, userContentType);
      });
    });
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await secretsManagerService.createSecretVersionLocks({});
        } catch (e) {
          err = e;
        }
  ...
  describe('listSecretVersionLocks', () => {
    describe('positive tests', () => {
      function __listSecretVersionLocksTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}/versions/{version_id}/locks', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(mockRequestOptions.qs.offset).toEqual(offset);
    ...
    describe('SecretVersionLocksPager tests', () => {
      const serviceUrl = secretsManagerServiceOptions.url;
      const path = '/v2/secrets/0b5571f7-21e6-42b7-91c5-3f5ac9793a46/versions/eb4cf24d-9cae-424b-945e-159788a5f535/locks';
      const mockPagerResponse1 =
        '{"next":{"href":"https://myhost.com/somePath?offset=1"},"total_count":2,"limit":1,"locks":[{"name":"name","description":"description","attributes":{"anyKey":"anyValue"},"created_at":"2022-04-12T23:20:50.520Z","updated_at":"2022-04-12T23:20:50.520Z","created_by":"iam-ServiceId-e4a2f0a4-3c76-4bef-b1f2-fbeae11c0f21","secret_group_id":"default","secret_id":"b49ad24d-81d4-5ebc-b9b9-b0937d1c84d5","secret_version_id":"b49ad24d-81d4-5ebc-b9b9-b0937d1c84d5","secret_version_alias":"current"}]}';
      const mockPagerResponse2 =
        '{"total_count":2,"limit":1,"locks":[{"name":"name","description":"description","attributes":{"anyKey":"anyValue"},"created_at":"2022-04-12T23:20:50.520Z","updated_at":"2022-04-12T23:20:50.520Z","created_by":"iam-ServiceId-e4a2f0a4-3c76-4bef-b1f2-fbeae11c0f21","secret_group_id":"default","secret_id":"b49ad24d-81d4-5ebc-b9b9-b0937d1c84d5","secret_version_id":"b49ad24d-81d4-5ebc-b9b9-b0937d1c84d5","secret_version_alias":"current"}]}';
      ...
      test('getNext()', async () => {
        const params = {
          id: '0b5571f7-21e6-42b7-91c5-3f5ac9793a46',
          versionId: 'eb4cf24d-9cae-424b-945e-159788a5f535',
          limit: 10,
          sort: 'name',
          search: 'testString',
        };
  ...
  describe('deleteSecretVersionLocks', () => {
    describe('positive tests', () => {
      function __deleteSecretVersionLocksTest() {
        // Construct the params object for operation deleteSecretVersionLocks
        const id = '0b5571f7-21e6-42b7-91c5-3f5ac9793a46';
        const versionId = 'eb4cf24d-9cae-424b-945e-159788a5f535';
        const name = ['lock-1'];
        const deleteSecretVersionLocksParams = {
          id,
          versionId,
          name,
        };

        const deleteSecretVersionLocksResult = secretsManagerService.deleteSecretVersionLocks(deleteSecretVersionLocksParams);

        // all methods should return a Promise
        expectToBePromise(deleteSecretVersionLocksResult);
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/secrets/{id}/versions/{version_id}/locks', 'DELETE');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(mockRequestOptions.qs.name).toEqual(name);
      ...
      test('should pass the right params to createRequest with enable and disable retries', () => {
        // baseline test
        __deleteSecretVersionLocksTest();
      ...
      test('should prioritize user-given headers', () => {
        ...
        secretsManagerService.deleteSecretVersionLocks(deleteSecretVersionLocksParams);
        checkMediaHeaders(createRequestMock, userAccept, userContentType);
      });
    });
    ...
    describe('negative tests', () => {
      test('should enforce required parameters', async () => {
        let err;
        try {
          await secretsManagerService.deleteSecretVersionLocks({});
        } catch (e) {
          err = e;
        }
  ...
  describe('createConfiguration', () => {
    describe('positive tests', () => {
      ...
      function __createConfigurationTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/configurations', 'POST');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
  ...
  describe('listConfigurations', () => {
    describe('positive tests', () => {
      function __listConfigurationsTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/configurations', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(mockRequestOptions.qs.offset).toEqual(offset);
  ...
  describe('getConfiguration', () => {
    describe('positive tests', () => {
      function __getConfigurationTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/configurations/{name}', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
  ...
  describe('updateConfiguration', () => {
    describe('positive tests', () => {
      ...
      function __updateConfigurationTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/configurations/{name}', 'PATCH');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/merge-patch+json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        checkUserHeader(createRequestMock, 'X-Sm-Accept-Configuration-Type', xSmAcceptConfigurationType);
  ...
  describe('deleteConfiguration', () => {
    describe('positive tests', () => {
      function __deleteConfigurationTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/configurations/{name}', 'DELETE');
        const expectedAccept = undefined;
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        checkUserHeader(createRequestMock, 'X-Sm-Accept-Configuration-Type', xSmAcceptConfigurationType);
  ...
  describe('createConfigurationAction', () => {
    describe('positive tests', () => {
      ...
      function __createConfigurationActionTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/configurations/{name}/actions', 'POST');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
  ...
  describe('createNotificationsRegistration', () => {
    describe('positive tests', () => {
      function __createNotificationsRegistrationTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/notifications/registration', 'POST');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
  ...
  describe('getNotificationsRegistration', () => {
    describe('positive tests', () => {
      function __getNotificationsRegistrationTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/notifications/registration', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
      }
  ...
  describe('deleteNotificationsRegistration', () => {
    describe('positive tests', () => {
      function __deleteNotificationsRegistrationTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/notifications/registration', 'DELETE');
        const expectedAccept = undefined;
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
      }
  ...
  describe('getNotificationsRegistrationTest', () => {
    describe('positive tests', () => {
      function __getNotificationsRegistrationTestTest() {
        ...
        checkUrlAndMethod(mockRequestOptions, '/v2/notifications/registration/test', 'GET');
        const expectedAccept = undefined;
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
      }
